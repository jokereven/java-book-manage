...
<body>
   ...
   <%
   GradeEntity  grade =(GradeEntity)request.getAttribute("myone");
   %>
				...
				<div class="box">
					<div class="box_border">
						...
						<div class="box_center">
							...
							<form method="post" action="${pageContext.request.contextPath }/GradeServlet?action=upp" class="jqtransform">
								<table class="form_table pt15 pb15" width="100%" border="0"
									cellpadding="0" cellspacing="0">
									<tr>
										<td class="td_right">年级名称：</td>
										<td class=""><input type="text" name="mname" id="ename"
											class="input-text lh30" size="40" value="<%=grade.getMname() %>"></td>
									...
									<tr>
										...
										<td class=""><textarea name="mremark" id="eremark" cols="30" rows="10"
												class="textarea" value="<%=grade.getMremark() %>"></textarea></td>
									</tr>

									<tr>
										<td class="td_right">&nbsp;</td>
										<input type="hidden" name="gid" value="<%=grade.getGid()%>"> 
